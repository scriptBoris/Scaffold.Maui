...
public partial class FlyoutViewCupertino : FlyoutViewBase
{
	public FlyoutViewCupertino() : base()
	{
		InitializeComponent();
    ...
    {
        private readonly FlyoutViewCupertino _parent;

        public FlyoutBackButtonBehavior(FlyoutViewCupertino parent)
        {
            _parent = parent;
        }
